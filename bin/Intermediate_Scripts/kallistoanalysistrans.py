...
Sorted.to_csv(f'{basename}_Kallisto_Transdecoder_all.csv')
top20.to_csv(f'{basename}_Kallisto_Transdecoder_top20.csv')
...
plt.tick_params(
    ...
    top=False,
    labelbottom=False)
plt.savefig(f'{basename}_Kallisto_Transdecoder_top500graph.png')
...
plt.savefig(f'{basename}_Kallisto_Transdecoder_top20graph.png')
