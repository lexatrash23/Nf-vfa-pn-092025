...
write.csv(transdf_distinct_blastn, paste0(sample, "_transdf_distinct_nomasspec_blastn_full.csv"), row.names = FALSE)
...
write.csv(transdf_distinct_blastn, paste0(sample, "_transdf_distinct_nomasspec_blastn_simplified.csv"), row.names = FALSE)
