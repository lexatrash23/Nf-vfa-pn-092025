...
process kallistoAnalysisTrinity {
    ...
    conda "${launchDir}/bin/Setup/VenomFlowAnalysis2.yaml"
    ...
    python3 ${launchDir}/bin/Intermediate_Scripts/kallistoanalysistrinity.py ./ ${params.basename} ${kallisto_file_trinity}
    """
}
...
process kallistoAnalysisTrans {
    ...
    python3 ${launchDir}/bin/Intermediate_Scripts/kallistoanalysistrans.py ./ ${params.basename} ${kallisto_file_transdecoder}
    """
}
...
process ExtractSignalSequences {
    ...
    python3 ${launchDir}/bin/Intermediate_Scripts/IS2.py ${transdecoder_pep} ${mature_fasta} signalsequences.fasta
    """
...
process CreateTrinityDataframe {
    ...
    Rscript ${launchDir}/bin/Intermediate_Scripts/IS1.R ${trinity_fasta} ${blastx_file} ${kallisto_csv}
    """
...
process CreateInterproscanDataframe {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts/IS4.R" ${Interproscan} ${ListFile} ${PantherFile}
    """
...
process CreateTransdecoderDataframe {
    ...
    Rscript ${launchDir}/bin/Intermediate_Scripts/IS5.R ${transdecoder_pep} ${transdecoder_cds} ${blastp_file} ${mature_fasta} ${Signalp_summary} ${signalsequences} ${Interproscan_dataframe} ${kallistotrans} ${basename}
    """
...
process CreateInterproscanToxinPlotly {
    ...
    Rscript ${launchDir}/bin/Intermediate_Scripts/IS7.R ${transdf_distinct_csv} ${Toxin_domains} ${transtoxinfasta}
    """
...
process BUSCOtranscriptome {
    conda "${launchDir}/bin/Setup/busco2.yaml"
    ...
    python3 "${launchDir}/bin/Intermediate_Scripts/IS6.py" -wd "${params.data}/busco_transcriptome/"
    """
...
process BUSCOtranslatome {
    ...
    python3 "${launchDir}/bin/Intermediate_Scripts/IS6.py" -wd "${params.data}/busco_translatome/"
...
process TableGenerationTrinity {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts2/Generating_TopTables_Trinity.R" ${TBK} ${genome_id} ${species}
    """
...
process TableGenerationTransdecoder {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts2/Generating_Tables_Transdecoder_SignalP.R" ${transdf} ${genome_id} ${species}
    """
...
process FigureGenerationTrinity {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts2/Figure_generation_Trinity.R" ${TBK} ${colour}
...
process FigureGenerationTransdecoder {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts2/Figure_generation_Transdecoder.R" ${transdf} ${colour}
...
process FigureGenerationSignalp {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts2/Figure_generation_SignalP.R" ${transdf} ${colour}
...
process AddMassSpec {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts/IS8.R" ${transdf} ${massspecdata} "${species}" ${basename}
...
process SkipMassSpec {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts/IS9.R" ${transdf} "${species}" ${basename}
...
process VennOverviewMS {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts/IS10.R" ${filtered_massspec} "${Toxin_domains}"
...
process VennOverviewNoMS {
    ...
    Rscript "${launchDir}/bin/Intermediate_Scripts/IS10.R" ${filtered_nomasspec} "${Toxin_domains}"
...
process RmarkdownA {
    ...
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/A.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" "${sampleURL}" "${params.name}"
    """
...
process RmarkdownB {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/B.Rmd',
      output_dir='.',
      params=list(
...
process RmarkdownCDEGIK {
    ...
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/C.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" ${params.name}
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/D.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" ${params.name}
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/E.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" ${params.name}
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/G.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" ${params.name}
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/I.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" ${params.name}
    Rscript -e "rmarkdown::render('${launchDir}/bin/Rmarkdown_scripts/K.Rmd', output_dir = '.')" "${launchDir}/bin/Rmarkdown_scripts/" ${params.name}
...
process RmarkdownH {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/H.Rmd',
      output_dir='.',
      params=list(
...
process RmarkdownJ {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/J.Rmd',
      output_dir='.',
      params=list(
...
process RmarkdownL {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/L.Rmd',
      output_dir='.',
      params=list(
...
process RmarkdownM {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/M.Rmd',
      output_dir='.',
      params=list(
        Table1='\$Table1_abs',
        name = '${params.name}'
...
process RmarkdownN {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/N.Rmd',
      output_dir='.',
      params=list(
        Table2='\$Table2_abs',
        Table3='\$Table3_abs',
...
process RmarkdownO {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/O.Rmd',
      output_dir='.',
      params=list(
        Table4='\$Table4_abs',
        name = '${params.name}'
...
process RmarkdownQ {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/Q.Rmd',
      output_dir='.',
      params=list(
        Table5='\$Table5_abs',
        name = '${params.name}'
...
process RmarkdownR {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/R.Rmd',
      output_dir='.',
      params=list(
        Table6='\$Table6_abs',
        Table7='\$Table7_abs',
...
process RmarkdownS {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/S.Rmd',
      output_dir='.',
      params=list(
        Table8='\$Table8_abs',
        name = '${params.name}'
...
process RmarkdownV {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/V.Rmd',
      output_dir='.',
      params=list(
        Table9='\$Table9_abs',
        name = '${params.name}'
...
process RmarkdownW {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/W.Rmd',
      output_dir='.',
      params=list(
        Table10='\$Table10_abs',
        Table11='\$Table11_abs',
...
process RmarkdownX {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/X.Rmd',
      output_dir='.',
      params=list(
        Table12='\$Table12_abs',
        name = '${params.name}'
...
process Movefilteredseq {
    ...
    script:
    """
    mv "${launchDir}/results/htmls/filtered_sequences.fasta" "${launchDir}/results/Intermediate_Scripts1_outputs/filtered_sequences.fasta"
    """
}
...
process RmarkdownZ {
    ...
    Rscript -e "rmarkdown::render(
      '${launchDir}/bin/Rmarkdown_scripts/Z.Rmd',
      output_dir='.',
      params=list(
        VENN='\$Venn_abs',
        TABLE='\$table_abs',
